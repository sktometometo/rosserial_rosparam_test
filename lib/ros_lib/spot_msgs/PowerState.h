...
namespace spot_msgs
{
  ...
  class PowerState : public ros::Msg
  {
    public:
      ...
      typedef float _locomotion_charge_percentage_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 0) = (this->shore_power_state >> (8 * 0)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->locomotion_charge_percentage);
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += sizeof(this->shore_power_state);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->locomotion_charge_percentage));
