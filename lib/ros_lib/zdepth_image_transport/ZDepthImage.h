#ifndef _ROS_zdepth_image_transport_ZDepthImage_h
#define _ROS_zdepth_image_transport_ZDepthImage_h
...
namespace zdepth_image_transport
{
  ...
  class ZDepthImage : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "zdepth_image_transport/ZDepthImage"; };
    virtual const char * getMD5() override { return "b567eabe13717816ed52eecedd17fb24"; };
