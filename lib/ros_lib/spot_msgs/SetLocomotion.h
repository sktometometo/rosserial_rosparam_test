...
static const char SETLOCOMOTION[] = "spot_msgs/SetLocomotion";
  ...
  class SetLocomotionRequest : public ros::Msg
  {
    public:
      ...
      enum { HINT_AUTO =  1    };
      enum { HINT_TROT =  2    };
      enum { HINT_SPEED_SELECT_TROT =  3    };
      enum { HINT_CRAWL =  4    };
      enum { HINT_SPEED_SELECT_CRAWL =  10   };
      enum { HINT_AMBLE =  5    };
      enum { HINT_SPEED_SELECT_AMBLE =  6    };
      enum { HINT_JOG =  7    };
      enum { HINT_HOP =  8    };
      enum { HINT_AUTO_TROT =  3    };
    ...
    virtual const char * getMD5() override { return "97b40092a18edece4f95bc953317ee0d"; };
